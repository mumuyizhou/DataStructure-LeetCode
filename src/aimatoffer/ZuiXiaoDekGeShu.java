...
public class ZuiXiaoDekGeShu {
	 ...
	 * @return
	 */
	public int[] getLeastNumbersUsingHeap(int[] arr, int k) {
		if (k == 0)
			return new int[0];
		int len = arr.length;
		if (k == len)
	...
	//维护大顶堆的函数，和当前节点的左右子节点比较，如果节点中有更大的数，那么交换，并继续对交换后的节点进行维护
	//i:要维护的节点。
	...
	public static void main(String[] args) {
		ZuiXiaoDekGeShu xiao = new ZuiXiaoDekGeShu();
		System.out.println(Arrays.toString(xiao.getLeastNumbers(new int[]{4,3,1,2,0,100,0,1,9,9}, 8)));
		System.out.println(Arrays.toString(xiao.getLeastNumbersUsingHeap(new int[]{4,3,1,2,0,100,0,1,9,9}, 8)));
	}
